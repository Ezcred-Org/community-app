...
public interface DocumentService {
     ...
     * @param nameOfDocument          - Document Name
     * @param description             - Mandatory - Document Description
     * @param fileName                - Mandatory - fileName of actual document.
     * @param fileLocation            - Mandatory - location of the actual document.
     */
    @POST("{entityType}/{entityId}/" + APIEndPoint.DOCUMENTS + "/metadata")
    Observable<GenericResponse> createDocumentLocation(@Path("entityType") String entityType,
                                                       @Path("entityId") int entityId,
                                                       @Query("name") String nameOfDocument,
                                                       @Query("description") String description,
                                                       @Query("fileName") String fileName,
                                                       @Query("fileLocation") String fileLocation);
