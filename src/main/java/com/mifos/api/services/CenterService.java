...
public interface CenterService {
    ...
    Observable<GenericResponse> saveCollectionSheet(
            @Path("centerId") int centerId,
            @Body CollectionSheetPayload collectionSheetPayload);

    @POST(APIEndPoint.CENTERS + "/{centerId}?command=saveCollectionSheet")
    Observable<GenericResponse> saveCollectionSheetAsync(
            @Path("centerId") int centerId,
            @Body CollectionSheetPayload collectionSheetPayload);
    ...
    Observable<GenericResponse> createCenter(@Body CenterPayload centerPayload);
