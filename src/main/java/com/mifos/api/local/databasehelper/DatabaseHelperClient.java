    ...
    public Observable<ClientsTemplate> saveClientTemplate(final ClientsTemplate clientsTemplate) {
        return Observable.defer(new Func0<Observable<ClientsTemplate>>() {
            ...
            public Observable<ClientsTemplate> call() {
                ...
                if (clientsTemplate.getOfficeOptions() != null) {
                    for (OfficeOptions officeOptions : clientsTemplate.getOfficeOptions()) {
                        officeOptions.save();
                    }
                }

                if (clientsTemplate.getStaffOptions() != null) {
                    for (StaffOptions staffOptions : clientsTemplate.getStaffOptions()) {
                        staffOptions.save();
                    }
                }

                if (clientsTemplate.getSavingProductOptions() != null) {
                ...
                if (clientsTemplate.getGenderOptions() != null) {
                ...
                if (clientsTemplate.getClientTypeOptions() != null) {
                ...
                if (clientsTemplate.getClientClassificationOptions() != null) {
                ...
                if (clientsTemplate.getClientLegalFormOptions() != null) {
                ...
                if (clientsTemplate.getDataTables() != null) {
