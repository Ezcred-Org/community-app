...
public class DataManager {
    ...
    public Observable<GenericResponse> saveCollectionSheet(int centerId, CollectionSheetPayload
            collectionSheetPayload) {
        return mBaseApiManager.getCenterApi().saveCollectionSheet(
                centerId, collectionSheetPayload);
    }

    public Observable<GenericResponse> saveCollectionSheetAsync(int id,
    ...
    public Observable<Page<Loans>> getAllLoans() {
        return mBaseApiManager.getLoanApi().getAllLoans(null, null, null, null, null, null,null,null,null);
    }
    ...
    Observable<LoanProducts> getLoanProduct(long loanProductId) {
